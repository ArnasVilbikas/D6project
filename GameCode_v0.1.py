...
def nextPosition(direction):
    ...
    if tentativePosition[0] > 20 or tentativePosition[1] > 20 or arena[tentativePosition[1] - 1][tentativePosition[0] - 1] == 'w':
        ...
        screen.blit(bg,pixelPosition(userPosition[0],userPosition[1]))
        return None
    #ammo, for some reason i get an error when i try to return ammo
    elif tentativePosition[0]==2 and tentativePosition[1]==3:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==17 and tentativePosition[1]==3:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==10 and tentativePosition[1]==9:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==2 and tentativePosition[1]==10:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==12 and tentativePosition[1]==11:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==2 and tentativePosition[1]==3:
        ...
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==19 and tentativePosition[1]==10:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==2 and tentativePosition[1]==17:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None
    elif tentativePosition[0]==19 and tentativePosition[1]==18:
        ammo=ammo+1
        screen.blit(bg,pixelPosition(tentativePosition[0],tentativePosition[1]))
        return None        
    else:
